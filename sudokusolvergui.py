...
def show_ans():
    for i in range(9):
        for j in range(9):
            ...
            if solution[i][j] == 1 and original[i][j] == 0: 
                pg.draw.rect(screen, (255,255,255), (40*(j+1)-18,40*(i+1)-18,36,36))
                screen.blit(r_one, (posx,posy)) 
            elif solution[i][j] == 2 and original[i][j] == 0: 
                pg.draw.rect(screen, (255,255,255), (40*(j+1)-18,40*(i+1)-18,36,36))
                screen.blit(r_two, (posx,posy)) 
            elif solution[i][j] == 3 and original[i][j] == 0: 
                pg.draw.rect(screen, (255,255,255), (40*(j+1)-18,40*(i+1)-18,36,36))
                screen.blit(r_three, (posx,posy)) 
            elif solution[i][j] == 4 and original[i][j] == 0: 
                pg.draw.rect(screen, (255,255,255), (40*(j+1)-18,40*(i+1)-18,36,36))
                screen.blit(r_four, (posx,posy)) 
            elif solution[i][j] == 5 and original[i][j] == 0: 
                pg.draw.rect(screen, (255,255,255), (40*(j+1)-18,40*(i+1)-18,36,36))
                screen.blit(r_five, (posx,posy)) 
            elif solution[i][j] == 6 and original[i][j] == 0: 
                pg.draw.rect(screen, (255,255,255), (40*(j+1)-18,40*(i+1)-18,36,36))
                screen.blit(r_six, (posx,posy)) 
            elif solution[i][j] == 7 and original[i][j] == 0: 
                pg.draw.rect(screen, (255,255,255), (40*(j+1)-18,40*(i+1)-18,36,36))
                screen.blit(r_seven, (posx,posy)) 
            elif solution[i][j] == 8 and original[i][j] == 0: 
                pg.draw.rect(screen, (255,255,255), (40*(j+1)-18,40*(i+1)-18,36,36))
                screen.blit(r_eight, (posx,posy)) 
            elif solution[i][j] == 9 and original[i][j] == 0: 
                pg.draw.rect(screen, (255,255,255), (40*(j+1)-18,40*(i+1)-18,36,36))
